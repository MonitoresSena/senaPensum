        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{ route('admin.usuarios.index') }}"><i class="fa fa-user"></i> Usuarios</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.roles.index') }}"><i class="fa fa-user-plus"></i> Roles</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.permisos.gestionar') }}"><i class="fa fa-key"></i> Gestionar permisos</a>
                        </li>
                    </ul>
                ...
                <li>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-cube"></i> Competencias <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{ route('admin.Competencias.index') }}"><i class="fa fa-list"></i> Listar Competencias</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.Competencias.create') }}"><i class="fa fa-plus"></i> Registrar Competencia</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-check"></i> Resultados <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{ route('admin.Resultados.index') }}"><i class="fa fa-list"></i> Listar Resultados</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.Resultados.create') }}"><i class="fa fa-plus"></i> Registrar Resultados</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-list"></i> Unidades temáticas <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{ route('admin.Unidades.index') }}"><i class="fa fa-list"></i> Listar Unidades tematicas</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.Unidades.create') }}"><i class="fa fa-plus"></i> Registrar Unidades tematicas</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-check-square-o"></i> Criterios <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{ route('admin.Criterios.index') }}"><i class="fa fa-list"></i> Listar Criterios</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.Criterios.create') }}"><i class="fa fa-plus"></i> Registrar Criterios</a>
                        </li>
                    </ul>
                </li>
